        ...
        >
          ...
          <div className="flex flex-wrap items-start justify-center gap-8 md:gap-12">
            {youtubers.map((y, i) => (
              ...
              >
                <div className="relative w-24 h-24 md:w-28 md:h-28 rounded-full overflow-hidden ring-2 ring-white/10 group-hover:ring-cyan-400/60 transition-all duration-300 group-hover:-translate-y-1.5 shadow-xl shadow-black/30">
                  <div
