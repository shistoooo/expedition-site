        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 relative z-10 mt-4">
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-[#5865F2] hover:bg-[#4752C4] transition-all font-bold text-lg shadow-lg shadow-[#5865F2]/25"
            >
              <svg
                className="w-6 h-6"
                viewBox="0 0 24 24"
