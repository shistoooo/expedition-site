...
export default function DiscordPionnierStickyMobileCTA() {
  ...
  useEffect(() => {
    const pricing = document.getElementById("discord-pionnier-pricing");
    if (!pricing) return;
    ...
    >
      <div className="px-4 pt-3 flex items-center justify-between gap-3">
        ...
        <div className="min-w-0 flex-shrink">
          ...
          <p className="text-[10px] text-purple-300/80 font-mono uppercase tracking-wider truncate">
            Bloqué à vie
          </p>
        </div>
