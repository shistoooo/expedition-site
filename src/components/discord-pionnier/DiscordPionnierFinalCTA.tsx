    ...
    <>
      ...
      <section className="py-20 md:py-28 relative">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 70% 60% at 50% 50%, rgba(139,92,246,0.14) 0%, rgba(99,60,200,0.07) 45%, transparent 72%)",
            filter: "blur(2px)",
          }}
        />
        ...
        <div className="container-main max-w-2xl relative z-10">
          ...
          >
            ...
            <p className="text-base md:text-lg text-white/55 mb-10 leading-relaxed">
              Devenir Pionnier prend 60 secondes.{" "}
              <span className="text-white/80">Le tarif est bloqué à vie.</span>
            </p>

            <Link
              href={ctaHref}
              onClick={() => fireCtaEvent("final")}
              className="group inline-flex items-center gap-2 px-10 py-5 rounded-xl bg-white text-black font-bold text-lg transition-all duration-200 border border-white/20 shadow-[0_1px_3px_rgba(0,0,0,0.1),0_12px_40px_rgba(139,92,246,0.35)] hover:shadow-[0_1px_3px_rgba(0,0,0,0.1),0_18px_60px_rgba(139,92,246,0.5)] hover:translate-y-[-2px] active:translate-y-[1px]"
            >
              {ctaLabel}
              {SALES_OPEN ? (
        ...
        <div className="container-main max-w-6xl">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-xs">
            <p className="text-white/35 font-mono uppercase tracking-wider">
              EXPÉDITION — Construit avec passion depuis Paris
            </p>
