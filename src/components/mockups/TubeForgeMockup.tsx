...
import { Scissors, FileText, Search, Video, Music, Download, CheckCircle2, ChevronRight, Loader2, Play, FileUp, FolderOpen } from "lucide-react";
import Image from "next/image";

const easeOutExpo: [number, number, number, number] = [0.16, 1, 0.3, 1];

export default function TubeForgeMockup() {
