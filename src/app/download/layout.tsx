...
export const metadata: Metadata = {
  ...
  description:
    "Téléchargez des vidéos YouTube en MP4 gratuitement avec TubeForge Web. Qualité 720p, 15 téléchargements par jour. Passez à Pro pour la vitesse maximale et le 8K.",
  openGraph: {
