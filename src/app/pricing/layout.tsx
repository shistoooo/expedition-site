...
export const metadata: Metadata = {
  ...
  description: "Rejoignez la Vague Pionnier dès 7,99€/mois — tarif bloqué tant que vous restez abonné. TubeForge, ClipForge, ReviewForge et plus.",
  openGraph: {
    title: "Tarifs — Expédition | Dès 7,99€/mois",
