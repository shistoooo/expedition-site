...
import { ArrowLeft, ArrowRight, Play, MessageCircle, Shield, Clock, Eye, Link2 } from "lucide-react";
      ...
      <main className="w-full relative z-10">
        ...
        <section className="pt-28 md:pt-36 pb-10 md:pb-14 relative">
          <div className="container-main max-w-3xl mx-auto text-center">
            ...
            >
              <p className="text-xs font-mono uppercase tracking-widest text-emerald-300/70 mb-5 flex items-center justify-center gap-2">
              ...
              <p className="text-sm text-white/35 mb-5 font-mono uppercase tracking-wider">
                L&apos;alternative à Frame.io
              </p>
              <p className="text-lg md:text-xl text-white/60 leading-relaxed max-w-2xl mx-auto mb-8">
                Partage tes montages en cours avec tes clients ou ton équipe. Sécurisé, temporaire, sans upload.
              </p>

              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-500/10 border border-emerald-400/25 text-emerald-200 text-sm font-medium">
                <span className="relative flex h-2 w-2">
                  <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-60" />
                  <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-400" />
                </span>
                En préparation &mdash; inclus dans l&apos;abonnement Pionnier
              </div>
            </motion.div>
          </div>
        </section>
          ...
          <div className="container-main">
            ...
            >
              <div
                ...
                style={{
                  background: "radial-gradient(ellipse 60% 60% at 50% 50%, rgba(16,185,129,0.20) 0%, rgba(34,211,238,0.10) 40%, transparent 75%)",
                  filter: "blur(40px)",
                }}
              />
              <div
                className="relative rounded-2xl overflow-hidden border border-white/10 bg-black/40"
                style={{ boxShadow: "0 20px 60px -15px rgba(16,185,129,0.35)" }}
              >
                <div className="aspect-video w-full">
                  {REVIEWFORGE_VIDEO_ID ? (
                    ...
                    <div className="w-full h-full flex flex-col items-center justify-center gap-4 text-center px-6">
                      <span className="w-16 h-16 rounded-full bg-emerald-500/15 border border-emerald-400/30 flex items-center justify-center">
                        <Play className="w-7 h-7 text-emerald-300 ml-0.5" />
                      </span>
                      <p className="text-white/70 font-semibold">La démo ReviewForge arrive très vite</p>
            ...
            <div className="flex flex-col lg:flex-row-reverse items-center gap-12 lg:gap-16">
              ...
              <div className="group relative w-full lg:flex-[1.3] transition-all duration-500 hover:-translate-y-1">
                <div
                  ...
                  style={{
                    background: "radial-gradient(ellipse at 50% 50%, rgba(16,185,129,0.12) 0%, rgba(34,211,238,0.05) 40%, transparent 70%)",
                    filter: "blur(80px)",
                  }}
                />
                <ReviewForgeMockup />
              ...
              <div className="w-full lg:flex-1 text-left">
                <h2 className="text-2xl md:text-3xl font-black tracking-[-0.02em] mb-6">
                  Ce que ReviewForge fait pour toi
                </h2>
        ...
        <SuiteRoadmap highlight="reviewforge" />
        ...
        <section className="py-16 md:py-24 relative">
          <div className="container-main max-w-2xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-black tracking-[-0.02em] mb-4">
              Bloque ton tarif avant ReviewForge
            </h2>
            <p className="text-base md:text-lg text-white/55 leading-relaxed mb-8">
              En rejoignant la Vague Pionnier aujourd&apos;hui, tu profites de TubeForge tout de suite &mdash; et ReviewForge te rejoindra sans un centime de plus.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <Link
                href="/pricing"
                className="group inline-flex items-center gap-2 px-7 py-3.5 rounded-xl bg-white text-black font-bold text-sm border border-white/20 shadow-[0_1px_3px_rgba(0,0,0,0.1),0_8px_24px_rgba(16,185,129,0.25)] hover:shadow-[0_1px_3px_rgba(0,0,0,0.1),0_12px_40px_rgba(16,185,129,0.4)] transition-all duration-200 hover:translate-y-[-1px] active:translate-y-[1px]"
              >
